<?php /* Smarty version Smarty-3.1.19-dev, created on 2018-08-02 13:19:26
         compiled from "backend/design/html/banners_image.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19009609335b6304de114d45-91866516%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6b1c80ed6a47fbf6bd3e9c91ebd9c736de4c90eb' => 
    array (
  ...
  'nocache_hash' => '19009609335b6304de114d45-91866516',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b6304de1a14f3_08644634',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b6304de1a14f3_08644634')) {function content_5b6304de1a14f3_08644634($_smarty_tpl) {?><?php if ($_smarty_tpl->tpl_vars['banners_image']->value->id) {?>
...
<?php } else { ?>
    <?php $_smarty_tpl->tpl_vars['meta_title'] = new Smarty_variable($_smarty_tpl->tpl_vars['btr']->value->banners_image_add_banner, null, 1);
if ($_smarty_tpl->parent != null) $_smarty_tpl->parent->tpl_vars['meta_title'] = clone $_smarty_tpl->tpl_vars['meta_title'];?>
<?php }?>
                    ...
                    <input type="hidden" class="fn_accept_delete" name="delete_image" value="">
                        <div class="banner_image text-xs-center">
                            <?php if ($_smarty_tpl->tpl_vars['banners_image']->value->image) {?>
                                ...
                                <img class="admin_banner_images" src="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['resize'][0][0]->resize_modifier($_smarty_tpl->tpl_vars['banners_image']->value->image,465,265,false,$_smarty_tpl->tpl_vars['config']->value->resized_banners_images_dir);?>
" alt="" />
                            <?php }?>
                        </div>
